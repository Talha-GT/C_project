            ...
            if (a[i][j] == -1)
            {
                ...
                for (int r = 0; r < n; r++)
                {
                    ...
                    for (int c = 0; c < n; c++)
                    {
                        if (a[r][c] == 0 || a[r][c] == -1)
                        {
                            printf(GREEN "%4d " RESET, a[r][c]);
                        }
                        else if (r == i && c == j)
                        {
                            printf(RED "%4d " RESET, a[r][c]);
                        }
                        else
                        {
                            printf("%4d ", a[r][c]);
...
void single_even(int n)
{
    ...
    for (int i = 1; i <= (n / 2) * (n / 2); i++)
    {
        ...
        for (int r = 1; r <= n; r++)
        {
            ...
            for (int c = 1; c <= n; c++)
            {
                if (a[r][c] == 0)
                {
                    // Zero values in green
                    printf("\033[1;32m%4d \033[0m", a[r][c]);
                }
                else if (a[r][c] == cnt - 1)
                {
                    // Current value in red
                    printf("\033[1;31m%4d \033[0m", a[r][c]);
                }
                else
                {
                    // Previous values in default color
                    printf("%4d ", a[r][c]);
                }
                rowSum += a[r][c];
            }
    ...
    for (i = 1; i <= (n / 2 - 1) / 2; i++)
    {
        for (j = 1; j <= (n / 2 - 1) / 2; j++)
        {
            // Highlight the swapped cells in yellow
            printf("\033[1;33m");
            printf("Swapping indices: (%d, %d) and (%d, %d)\n", i, j, i + n / 2, j);
            printf("\033[0m");
    ...
    // Second loop swap (highlight yellow cells)
    j = (n / 2 + 1) / 2, k = 2;
    for (i = 1; i <= (n / 2 - 1) / 2; i++)
    {
        // Highlight the swapped cells in yellow
    ...
    // Third loop swap (highlight yellow cells)
    k = (n / 2) / 2 + 2;
    for (i = 1; i <= (n / 2 - 1) / 2; i++)
    {
        for (j = 1; j <= (n / 2 - 1) / 2; j++)
